...
const PaymentProofs = () => {
  const {getPaymentProofs,singlePaymentProof,
    paymentProofs,deletePaymentProof,getPaymentProof}=useSuper()
    ...
    const handleFetchPaymentDetail =(id)=>{
      console.log("id desde: handleFetchPaymentDetail", id)
      getPaymentProof(id);
    }
...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  const {updatePaymentProof, singlePaymentProof, loading}=useSuper();
...
const navigate=useNavigate()
  ...
  const handlePaymentProofUpdate = () => {
    console.log("Datos desde handle payment proof detail",singlePaymentProof._id, status, amount)
    updatePaymentProof(singlePaymentProof._id, status, amount);
